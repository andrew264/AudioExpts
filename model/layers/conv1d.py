...
def remove_padding_1d(x: torch.Tensor, paddings: tuple[int, int]) -> torch.Tensor:
...
def calculate_extra_padding(x: torch.Tensor, kernel_size: int, stride: int, padding: int = 0) -> int:
...
def pad_tensor_1d(x: torch.Tensor, paddings: tuple[int, int], mode: str = "constant", value: float = 0.0) -> torch.Tensor:
